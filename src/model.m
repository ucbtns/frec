function mdp = model(seed, one, two,  p,T,dc)
                       ...
                       if (f3 == 1 )
                        ...
                        elseif (f3 == 2)
                         ...
                         if f3 == 1 
                            A{2}(3,1:n,:,f3, 1) = 1;     
                            A{2}(3,1:n ,:,f3, 2) = pp;     
                            A{2}(1:2,1:n,:,f3, 2) = 1-pp; 
                            
                        elseif (f1 ~= f2)
                            
                           A{2}(2,f1,f2,f3, 1) = 1; 
                           A{2}(2,f1,f2,f3, 2) =pp; 
                           A{2}([1,3],f1,f2,f3, 2) =1-pp; 
                      
                        elseif (f2 == f1) 
                        
                            A{2}(1,f1,f2,f3, 1) = 1;
                            A{2}(1,f1,f2,f3, 2) = pp;     
                            A{2}(2:3,f1,f2,f3, 2) = 1-pp;         
                        end   
                                         
                        if f3 == 1
                            A{3}(:,f1, :,f3, 1) = [ones(n,n)*e+eye(n,n)];  
                            A{3}(:,f1, :,f3, 2) = [ones(n,n)*1-pp+(pp-(1-pp))*eye(n,n)]; 
                        else
                             A{3}(:,1:end,f2,f3, 1) = [eye(n,n)];
                             A{3}(:,1:end,f2,f3, 2) = (pp-(1-pp))*eye(n,n)+1-pp;
                        end 
            end
        end
    end       
...
mdp.C = C;                      
mdp.D = D;   
if one ==1;mdp.chi = 1/exp(1024);
else; mdp.chi = 1/exp(16); end
mdp.b = b;
mdp.a = a;
